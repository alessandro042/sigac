...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="<?php echo e(route('matricula.interculturalidad.import-form')); ?>" class="btn btn-custom-upload btn-lg mx-2 my-2 shadow-sm">
                <i class="fas fa-file-upload"></i> Importar
            </a>
            <a href="<?php echo e(route('matricula.interculturalidad.generate.excel')); ?>" class="btn btn-custom-download btn-lg mx-2 my-2 shadow-sm">
                <i class="fas fa-file-download"></i> Exportar
            </a>
            <a href="<?php echo e(route('matricula.interculturalidad.export-excel', ['id_fechas_corte' => $fechaCorteSeleccionada->id ?? null])); ?>" class="btn btn-excel btn-lg mx-2 my-2 shadow-sm">
                <i class="fas fa-file-excel"></i> Exportar a Excel
            </a>
            <a href="<?php echo e(route('matricula.interculturalidad.export-pdf', ['id_fechas_corte' => $fechaCorteSeleccionada->id ?? null])); ?>" class="btn btn-pdf btn-lg mx-2 my-2 shadow-sm">
    ...
    <form action="<?php echo e(route('matricula.interculturalidad.report')); ?>" method="GET" class="mb-4">
                ...
                <table id="table-totales" class="table table-bordered table-striped table-general">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo e($totalIndigenas); ?></td>
                            <td class="text-center"><?php echo e($totalAfroamericanos); ?></td>
                            <td class="text-center"><?php echo e($totalInmigrantes); ?></td>
                    ...
                    <tfoot>
                        <tr>
                            <th>Total General</th>
                            <th class="text-center"><?php echo e($sumaTotalIndigenas); ?></th>
                            <th class="text-center"><?php echo e($sumaTotalAfroamericanos); ?></th>
                            <th class="text-center"><?php echo e($sumaTotalInmigrantes); ?></th>
                        ...
                        <table id="table-detalle-<?php echo e($loop->iteration); ?>" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo e($data->indigenas); ?></td>
                                    <td class="text-center"><?php echo e($data->afroamericanos); ?></td>
                                    <td class="text-center"><?php echo e($data->imigrantes); ?></td>
                                    <td class="text-center"><?php echo e($data->otros); ?></td>
                                    <td class="text-center">
                                        <?php echo e($data->indigenas + $data->afroamericanos + $data->imigrantes + $data->otros); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\aleja\Documents\Estadia alx\sieem\resources\views/matricula/interculturalidad/report.blade.php ENDPATH**/ ?>