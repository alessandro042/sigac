<?php $__env->startSection('title', 'Subir Archivo Excel'); ?>
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-5">
                    <div class="mb-4 text-center">
                        ...
                        <a href="<?php echo e(route('matricula.interculturalidad.generate.excel')); ?>" class="btn btn-lg btn-secondary text-white shadow-sm">
                            <i class="fas fa-file-download"></i> Descargar Plantilla Excel
                        </a>
                    </div>

                    <form action="<?php echo e(route('matricula.interculturalidad.import')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\aleja\Documents\Estadia alx\sieem\resources\views/matricula/interculturalidad/importar.blade.php ENDPATH**/ ?>