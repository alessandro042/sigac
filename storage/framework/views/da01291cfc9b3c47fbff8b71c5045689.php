<?php $__env->startSection('title', 'Matrícula Interculturalidad'); ?>
...
<div class="container mt-5">
    ...
    <div class="row mt-4">
        <div class="col-md-12 text-center">
            <a href="<?php echo e(route('matricula.interculturalidad.create')); ?>" class="btn btn-custom-admin btn-lg mx-2 my-2 shadow-sm">
              Crear
            </a>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $matriculas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $matricula): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($matricula->indigenas); ?></td>
                                <td><?php echo e($matricula->afroamericanos); ?></td>
                                <td><?php echo e($matricula->imigrantes); ?></td>
                                <td><?php echo e($matricula->otros); ?></td>
                                <td><?php echo e($matricula->total); ?></td>
                                <td>
                                    <a href="<?php echo e(route('matricula.interculturalidad.edit', $matricula->id)); ?>" class="btn btn-warning btn-sm">Editar</a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\aleja\Documents\Estadia alx\sieem\resources\views/matricula/interculturalidad/index.blade.php ENDPATH**/ ?>